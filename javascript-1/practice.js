...
//Code Here
let me = {firstName: `James`, state: `Utah`, age: 19, greeter: function(){return `Hello! My name is ${me.firstName} and I live in ${me.state}`}}
...
// Code Here
let total = myNumbers.reduce((accum, el) => accum + el)
...
// Code Here
let totallyAwesome = people.reduce((accumulator, element) => { return accumulator + element.awesomeLevel}, 0)
